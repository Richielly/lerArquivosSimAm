...
file = glob.glob(r'D:\Conversao\Frotas\Santa_Amelia\SimAm\SimAm\2021\01\Controle_Interno')
file_2 = glob.glob(r'D:\Conversao\Frotas\Santa_Amelia\SimAm\SimAm\2021\01\Controle_Interno')
print(file[0])
...
def data_inicial():
    ...
    #     sql = f"select * from SCP55_BEM where codbem = '{linha[0]}' union all"
        sql = f""" update SCF_VEICULOCONTROLESIMAM cs set cs.VLRACUMULADORINICIAL = {linha[4]} where cs.IDVEICULOCONTROLESIMAM = (select cs.IDVEICULOCONTROLESIMAM from SCF_VEICULOCONTROLESIMAM cs
                    ...
                    where
                    cs.dtlancamento between '01.01.2013' and '27.12.2023' and
